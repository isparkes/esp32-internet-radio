...
An ESP32-based internet radio with an OLED menu system and web interface.

## Hardware

- **ESP32-WROVER** (4MB flash + 4MB PSRAM) — PSRAM used for the audio streaming buffer
- **ESP32-WROOM** (4MB flash) — works without PSRAM too
